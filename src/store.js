...
export default new Vuex.Store({
  state: {
    food: [
      ...
      {
        name: "bowl", restaurant: "The Cane", desc: "Jowl sausage swine cow drumstick doner brisket chicken ball tip meatball frankfurter leberkas alcatra.Tenderloin picanha kielbasa capicola.Tail buffalo corned beef frankfurter drumstick hamburger fatback venison turkey pork loin biltong tongue beef.", tags: ["lunch", "cafe", "healthy"]
      },
      {
        name: "breakfast", restaurant: "la Salle du Nord", desc: "Ball tip pork belly turkey tri-tip, jerky leberkas tenderloin pork chop biltong prosciutto pancetta. Porchetta ground round ham bacon tri-tip jerky buffalo. Bresaola shoulder tail shankle.", tags: ["pancakes", "cafe", "fruit"]
      },
      {
        name: "burger2", restaurant: "Limestone", desc: "Hamburger sausage rump jowl kevin. Strip steak flank kevin biltong, landjaeger boudin leberkas chicken pork chop prosciutto ribeye ball tip. Tenderloin burgdoggen andouille pastrami venison.", tags: ["takeout", "sides", "meat"]
      },
      {
        name: "corn", restaurant: "Saffron", desc: "Ground round biltong bresaola drumstick fatback ham hock sausage t-bone, corned beef hamburger prosciutto. Short ribs spare ribs meatloaf leberkas, turducken picanha tail brisket jerky ball tip. Meatloaf chuck swine, tenderloin sirloin cupim short loin strip steak pork chop ham hock.", tags: ["dinner", "woodfire", "healthy"]
      },
      {
      ...
      {
        name: "egg2", restaurant: "Roadhouse", desc: "Spicy jalapeno frankfurter ribeye bacon short loin, biltong sirloin chuck prosciutto andouille pork rump strip steak corned beef fatback. Buffalo sausage beef ribs drumstick salami pastrami pork belly alcatra boudin tri-tip pork turkey turducken pork chop shank. Doner jerky andouille, shank spare ribs pork chop kevin.", tags: ["starters", "cafe", "pairings"]
      },
      {
        name: "fig", restaurant: "le Fleur Frais", desc: "Tail ham hock hamburger, tri-tip tenderloin turducken bresaola burgdoggen doner. Leberkas filet mignon pork burgdoggen pork chop, tri-tip doner cow. Shankle kevin ball tip bacon pork. Prosciutto meatloaf beef kevin sirloin tenderloin flank shankle turducken cupim corned beef porchetta ham hock andouille sausage.", tags: ["salad", "cafe", "lunch"]
      },
      {
      ...
      {
        name: "oyster", restaurant: "le Jardin", desc: "Jowl sausage swine cow drumstick doner brisket chicken ball tip meatball frankfurter leberkas alcatra.Tenderloin picanha kielbasa capicola.Tail buffalo corned beef frankfurter drumstick hamburger fatback venison turkey pork loin biltong tongue beef.", tags: ["lunch", "cafe", "healthy"]
      },
      {
        name: "pancake", restaurant: "The Locket", desc: "Ball tip pork belly turkey tri-tip, jerky leberkas tenderloin pork chop biltong prosciutto pancetta. Porchetta ground round ham bacon tri-tip jerky buffalo. Bresaola shoulder tail shankle.", tags: ["pancakes", "cafe", "fruit"]
      },
      {
        name: "pasta", restaurant: "Vagabonds", desc: "Hamburger sausage rump jowl kevin. Strip steak flank kevin biltong, landjaeger boudin leberkas chicken pork chop prosciutto ribeye ball tip. Tenderloin burgdoggen andouille pastrami venison.", tags: ["takeout", "sides", "meat"]
      },
      {
        name: "pasta2", restaurant: "Basil", desc: "Ground round biltong bresaola drumstick fatback ham hock sausage t-bone, corned beef hamburger prosciutto. Short ribs spare ribs meatloaf leberkas, turducken picanha tail brisket jerky ball tip. Meatloaf chuck swine, tenderloin sirloin cupim short loin strip steak pork chop ham hock.", tags: ["dinner", "woodfire", "healthy"]
      },
      {
        name: "pizza", restaurant: "The Parlour", desc: "Filet mignon bacon spare ribs meatball jowl pork belly cow ground round ham strip steak. Prosciutto flank fatback pastrami short loin turducken tenderloin tongue frankfurter venison drumstick beef ribs burgdoggen chicken brisket. Sirloin chuck filet mignon sausage, pork belly chicken brisket alcatra turducken buffalo ham ball tip ground round boudin.", tags: ["dinner", "chinese", "soup"]
      },
      {
        name: "plates", restaurant: "Trilogy", desc: "Spicy jalapeno frankfurter ribeye bacon short loin, biltong sirloin chuck prosciutto andouille pork rump strip steak corned beef fatback. Buffalo sausage beef ribs drumstick salami pastrami pork belly alcatra boudin tri-tip pork turkey turducken pork chop shank. Doner jerky andouille, shank spare ribs pork chop kevin.", tags: ["starters", "cafe", "pairings"]
      },
      {
        name: "popcicle", restaurant: "Paragon", desc: "Tail ham hock hamburger, tri-tip tenderloin turducken bresaola burgdoggen doner. Leberkas filet mignon pork burgdoggen pork chop, tri-tip doner cow. Shankle kevin ball tip bacon pork. Prosciutto meatloaf beef kevin sirloin tenderloin flank shankle turducken cupim corned beef porchetta ham hock andouille sausage.", tags: ["salad", "cafe", "lunch"]
      },
      {
      ...
      {
        name: "soup", restaurant: "The Glass Pantry", desc: "Jowl sausage swine cow drumstick doner brisket chicken ball tip meatball frankfurter leberkas alcatra.Tenderloin picanha kielbasa capicola.Tail buffalo corned beef frankfurter drumstick hamburger fatback venison turkey pork loin biltong tongue beef.", tags: ["lunch", "cafe", "healthy"]
      },
      {
        name: "steak", restaurant: "Castle", desc: "Ball tip pork belly turkey tri-tip, jerky leberkas tenderloin pork chop biltong prosciutto pancetta. Porchetta ground round ham bacon tri-tip jerky buffalo. Bresaola shoulder tail shankle.", tags: ["pancakes", "cafe", "fruit"]
      },
      {
        name: "steamed", restaurant: "Ambience", desc: "Hamburger sausage rump jowl kevin. Strip steak flank kevin biltong, landjaeger boudin leberkas chicken pork chop prosciutto ribeye ball tip. Tenderloin burgdoggen andouille pastrami venison.", tags: ["takeout", "sides", "meat"]
      },
      {
        name: "toast", restaurant: "The Village Cow", desc: "Ground round biltong bresaola drumstick fatback ham hock sausage t-bone, corned beef hamburger prosciutto. Short ribs spare ribs meatloaf leberkas, turducken picanha tail brisket jerky ball tip. Meatloaf chuck swine, tenderloin sirloin cupim short loin strip steak pork chop ham hock.", tags: ["dinner", "woodfire", "healthy"]
      },
      {
